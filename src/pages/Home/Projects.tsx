...
export default function Projects() {
  return (
    <>
      <section className="project animate w-full items-center justify-center bg-(--color-black-background) p-4 md:mt-12 md:px-8 lg:flex">
        <div className="flex flex-col items-center justify-center gap-4 rounded-xl p-4 lg:gap-6">
          <div className="project_animate flex w-full items-center justify-between">
            <h1 className="name bg-linear-to-b from-[#ffffff] to-[#ffffff] bg-clip-text font-Poppins text-2xl font-extrabold text-transparent md:text-5xl md:md:leading-22 lg:font-semibold">
              Projects
            </h1>
