...
export default function About() {
  return (
    <>
      <section className="about flex w-full flex-col items-center justify-center gap-8">
        <span className="z-10 hidden flex-col items-center justify-center gap-8 lg:flex">
          ...
          <article className="about_animate w-[100ch] space-y-4">
            <p className="max-w-55ch font-Cascadia w-full text-center text-[12px] text-white md:text-lg">
