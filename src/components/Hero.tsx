...
export default function Hero() {
  ...
  return (
    <>
      <section
        id="hero"
        className="h-[100vh] text-center w-full bg-[#181818] flex items-center justify-center"
      >
        <BrandLogo />
        ...
        <div id="box" className="flex flex-col items-center justify-evenly">
          ...
          <H1 className="heading font-Boska font-[800] text-[2.5rem] leading-[2.8rem] text-[#ffffe3] md:text-[5rem] md:leading-[5.2rem]">
            Full Stack
            <br />
            Web Developer
          </H1>
          ...
          <div className="flex items-center justify-center gap-4 mt-4">
            <Button className="bg-[#FEECEC] rounded-[12px] px-8 py-2 flex items-center justify-center text-black font-Cascadia font-[500]">
              Contact
            </Button>

            <Button className="bg-[#FEECEC] rounded-[12px] px-6 py-2 flex items-center justify-center text-black font-Cascadia font-[500]">
              Know More
            </Button>
          </div>
  ...
  return (
    <>
      <svg
        ...
        className="z-[9999] fixed top-[1.5rem] left-[1.5rem]"
      >
        <path
